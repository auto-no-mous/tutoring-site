...
class OAuthStartRequest(BaseModel):
    # Токен из ссылки-приглашения: тогда поток не входит и не привязывает провайдера
    # к текущей сессии, а отдаёт человеку заведённый репетитором профиль
    # (app.services.claim_service). Права здесь даёт токен, а не сессия.
