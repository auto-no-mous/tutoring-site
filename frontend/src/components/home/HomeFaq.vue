...
const items: FaqItem[] = [
  ...
  {
    q: "Я репетитор. Приведёт ли сайт мне учеников?",
    a:
      "Честный ответ — пока нет. Сайт не продвигается среди учеников, поэтому ждать заявок из каталога не стоит. " +
      "my-tutor.ru прежде всего инструмент для ведения индивидуальных и групповых занятий: расписание, записи, " +
      "группы, домашние задания, напоминания и чат. А чтобы записи всё-таки появлялись, разместите ссылку на свою " +
      "страницу там, где вас уже находят — в соцсетях, мессенджерах и объявлениях: ученик откроет её, увидит " +
      "свободное время и запишется сам.",
  },
  {
