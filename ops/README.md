...
сколько серий и групп проверено и сколько занятий создано). Обе задачи безопасно
запускать сколько угодно раз: существующие недели пропускаются, в прошлое занятия не
создаются.
